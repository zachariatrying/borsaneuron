...
st.markdown("<div class='brand-header'>WATCHLIST VE ALARM</div><div class='page-subtitle'>Hisselere fiyat alarmi koyun anlik kontrol edin</div>", unsafe_allow_html=True)
